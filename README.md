...
***get_news*** is a script to get all types of news in your whatsapp group.Visit [foo]: https://newsapi.org/ to get your own API key and paste it in newsapi = NewsApiClient(api_key="YOUR API KEY")
